...
<div class="advert-form">
    ...
    <?= $form->field($model, 'visible')->dropDownList(['0'=>'Не отображать на сайте','1'=>'Отображать на сайте'])->label('Показ на сайте') ?>
    ...
    <?= $form->field($model, 'type')->dropDownList(['Apartment','Building', 'Office Spase']) ?>
